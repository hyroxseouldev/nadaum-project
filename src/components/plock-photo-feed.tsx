...
interface PlockPhotoFeedProps {
  selectedCafeId?: string;
}

export function PlockPhotoFeed({ selectedCafeId }: PlockPhotoFeedProps) {
  ...
  // Photo grid using Plock masonry layout
  const PhotoGrid = () => (
    <Masonry
      items={photos}
      config={{
      ...
      render={(photo, idx) => (
        <div key={photo.id} className="overflow-hidden group">
          <Image
            src={photo.imageUrl}
